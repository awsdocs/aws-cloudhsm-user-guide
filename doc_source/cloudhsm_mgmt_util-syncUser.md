...
If you are synchronizing HSMs across cloned clusters, follow the instructions in [Using cloudhsm\_mgmt\_util Across Cloned Clusters](cloudhsm_mgmt_util-getting-started.md#cloudhsm_mgmt_util-syncConfig) and initialize cloudhsm\_mgmt\_util with the new config file\.
