...
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-5-4-0) | Released the AWS CloudHSM JCE provider version 5\.4\.0 for Windows platforms\. | February 1, 2022 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-5-4-0) | Released the AWS CloudHSM client version 5\.4\.0, which adds initial support for the JCE provider for all Linux platforms\. | January 28, 2022 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-5-3-0) | Released AWS CloudHSM client version 5\.3\.0, which adds additional support for the OpenSSL Dynamic Engine including ECDSA, OpenSSL 1\.0\.2, and platforms: Amazon Linux, Amazon Linux 2, Centos 7\.8\+, and RHEL 7\.8\+\. | January 3, 2022 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-3-4-4) | Released AWS CloudHSM client version 3\.4\.4 for all platforms\. | January 3, 2022 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-3-4-3) | Released AWS CloudHSM client version 3\.4\.3 for all platforms\. | December 20, 2021 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-3-4-2) | Released AWS CloudHSM client version 3\.4\.2 for all platforms\. | December 15, 2021 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-3-4-1) | Released AWS CloudHSM client version 3\.4\.1 for all platforms\. | December 10, 2021 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-5-2-1) | Released AWS CloudHSM client version 5\.2\.1, which adds improved stability and bug fixes\. | October 4, 2021 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-3-4-0) | Released AWS CloudHSM client version 3\.4\.0 for all platforms\. | August 25, 2021 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-5-2-0) | Released AWS CloudHSM client version 5\.2\.0, which adds new supported key types and mechanisms for the PKCS \#11 library\. | August 3, 2021 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-3-3-2) | Released AWS CloudHSM client version 3\.3\.2, which resolves an [issue](https://docs.aws.amazon.com/cloudhsm/latest/userguide/ki-all.html#ki-all-9) with the client\_info script\. | July 2, 2021 | 
| [Added new release](https://docs.aws.amazon.com/cloudhsm/latest/userguide/client-history.html#client-version-5-1-0) | Released AWS CloudHSM client version 5\.1\.0, which adds new supported mechanisms for the PKCS \#11 library\. | June 1, 2021 | 
