...
### Current Version: 1\.0\.18<a name="client-current-version"></a>
...
+ Improved stability when HSM connectivity is lost\.
+ Corrected handling of expired cluster certificate\.
+ Fixed various bugs\.
...
You can download version 1\.0\.14 from the following locations\.
+ Amazon Linux \(and compatible distributions\): [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-1.0-14.x86_64.rpm](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-1.0-14.x86_64.rpm) 
+ Ubuntu: [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client_1.0-14_amd64.deb](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client_1.0-14_amd64.deb) 
...
### Current Version: 1\.0\.18<a name="pkcs11-current-version"></a>
...
You can download version 1\.0\.14 from the following locations\.
+ Amazon Linux \(and compatible distributions\): [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-pkcs11-1.0-14.x86_64.rpm](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-pkcs11-1.0-14.x86_64.rpm)
+ Ubuntu: [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-pkcs11_1.0-14_amd64.deb](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-pkcs11_1.0-14_amd64.deb)
...
### Current Version: 1\.0\.18<a name="openssl-current-version"></a>
...
You can download version 1\.0\.14 from the following locations\.
+ Amazon Linux \(and compatible distributions\): [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-dyn-1.0-14.x86_64.rpm](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-dyn-1.0-14.x86_64.rpm) 
+ Ubuntu: [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-dyn_1.0-14_amd64.deb](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-dyn_1.0-14_amd64.deb)
...
### Current Version: 1\.0\.18<a name="java-current-version"></a>
...
Significant changes in this version include the following:
+ **\[Breaking Change\] **The LoginManager\.getInstance\(\) public method will no longer accept username and password arguments directly\. Instead see the alternative login mechanisms at [Log In To and Out Of an HSM](http://docs.aws.amazon.com/cloudhsm/latest/userguide/java-sample-login.html)\.
+ Added support for PKCS7Padding\.
...
You can download version 1\.0\.14 from the following locations\.
+ Amazon Linux \(and compatible distributions\): [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-jce-1.0-14.x86_64.rpm](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-jce-1.0-14.x86_64.rpm)
+ Ubuntu: [https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-jce_1.0-14_amd64.deb](https://s3.amazonaws.com/cloudhsmv2-software/cloudhsm-client-jce_1.0-14_amd64.deb)
